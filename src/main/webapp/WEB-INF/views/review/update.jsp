...
<form action="/review/update" method="post" enctype="multipart/form-data">
	...
	<div class="form-group">
		...
		<input type="text" id="rvTitle" name="rvTitle" class="form-control" value="${view.rvTitle} "/>
	</div>
	...
	<div class="form-group">
		...
		<textarea rows="10" style="width: 100%" id="rvContent" name="rvContent">${view.rvContent }</textarea>
	</div>
