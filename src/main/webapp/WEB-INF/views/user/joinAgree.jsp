...
<div class="container">
	<div class="pageHeader">
		<h3>회원가입</h3>
		<span class="pull-right"><span id="page">약관동의</span> ＞ 정보입력</span><br>
		<hr>
	</div><!-- End pageHeader -->
	...
	<div class="pageContent">
		<span></span>
		<br><br>
		<form id="termsForm" name="agreement" role="form">
			<div class="terms">
			...
			<label for="checkbox1" class="checkbox-inline">
				<input type="checkbox" id="checkbox1" name="agree1" value="">사이트 이용약관에 동의합니다.
			</label>
			<br><br><br>
		    <div class="terms">
			...
			<label for="checkbox2" class="checkbox-inline">
				<input type="checkbox" id="checkbox2" name="agree2" value="">개인정보 수집 및 이용에 동의합니다.
			</label>
			<br><br>
			<div align="center">
